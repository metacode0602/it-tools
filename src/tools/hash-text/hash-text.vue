...
<template>
  <div>
    <c-card>
      <c-input-text v-model:value="clearText" :placeholder="t('tools.hash-text.textPlaceholder')" rows="3" raw-text autosize autofocus multiline :label="t('tools.hash-text.textLabel')" />
      ...
      <c-select
        ...
        mb-4
        :label="t('tools.hash-text.selectLabel')"
        :options="[
          {
            label: 'Binary (base 2)',
            value: 'Bin',
